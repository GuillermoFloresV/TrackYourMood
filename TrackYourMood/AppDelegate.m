...
//source/credit goes to: https://stackoverflow.com/questions/2032818/adding-core-data-to-existing-iphone-project
- (void)saveContext{
    NSError *error = nil;
...
- (NSManagedObjectModel *)managedObjectModel{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PostModel" withExtension:@"momd"];
